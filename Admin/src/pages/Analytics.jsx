...
const Analytics = () => {
  ...
  const getDeviceIcon = (deviceType) => {
    switch (deviceType) {
      ...
      case "mobile":
        return <FaMobile size={14} />;
      case "tablet":
        return <FaTablet size={14} />;
      default:
        return <FaLaptop size={14} />;
    }
  };
    ...
    <Card sx={{ height: "100%" }}>
      <CardContent>
        ...
        >
          ...
          <Box
            sx={{
              backgroundColor: (theme) => theme.palette[color]?.light || "#eee",
              color: (theme) => theme.palette[color]?.main || "#000",
              borderRadius: 2,
              p: 1.5,
              display: "flex",
              alignItems: "center",
      ...
      <Box sx={{ maxWidth: "100%", mx: "auto" }}>
        ...
        <Box sx={{ mb: 4, display: "flex", alignItems: "center", gap: 2 }}>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, color: "text.secondary" }}>
            ...
            <Typography variant="caption">Click the eye icon to view full details</Typography>
          </Box>
        </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            >
              <StatsCard
                ...
                color="primary"
              />
              <StatsCard title="Unique Visitors" value={summary.uniqueVisitors} icon={<FaUsers size={24} />} color="success" />
              <StatsCard
                title="Desktop Users"
        ...
        {selectedRow && detailModalOpen && (
          ...
          >
            <Card sx={{ maxWidth: 600, maxHeight: "90vh", overflow: "auto" }} onClick={(e) => e.stopPropagation()}>
              <CardContent sx={{ p: 3 }}>
                <Typography variant="h6" gutterBottom sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <FaInfoCircle size={18} color="#1976d2" />
                  Activity Details
                </Typography>
                {/* All user, technical, device, location, navigation, action details here (same as your previous modal content) */}
              </CardContent>
            </Card>
          </Box>
        )}
