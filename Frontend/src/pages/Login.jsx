        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row transition-all duration-500 ease-in-out">
            ...
            <div className="h-full w-full">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex items-end">
                <div className="p-8 text-white">
                  <h2 className="text-2xl font-serif font-bold mb-2">Welcome Back to KB</h2>
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 transition-all duration-500 ease-in-out">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-serif font-bold text-gray-800 mb-2">Sign In to KB</h1>
              ...
              >
                {loading ? (
                  <>
                    ...
                    {isTransitioning ? "Welcome to KB! 🎉" : "Accessing KB..."}
                  </>
                ) : (
                  "Access My KB Account"
                )}
              </button>
            </form>
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">Future KB access options</span>
                </div>
              </div>
              ...
              <div className="mt-4 text-center">
                <p className="text-xs text-gray-500 italic">
                   KB Tip: Use your email and password for instant access to your beauty account
                </p>
              </div>
            </div>
          </div>
