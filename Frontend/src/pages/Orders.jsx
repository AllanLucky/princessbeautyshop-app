  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-2xl p-6 space-y-8">
        ...
        {/* Orders */}
        {orders.map((order) => (
          <div key={order._id} className="bg-gray-50 p-5 rounded-xl shadow-md space-y-6">
            <h2 className="text-2xl font-bold text-gray-700 border-b pb-2 mb-4">
              <span className="text-xl font-medium">Order</span>
              <span className="ml-2 text-pink-600">#{order._id}</span>
            </h2>
              ...
              <div className="flex flex-col space-y-4">
                {order.products?.map((product) => (
                  ...
                  >
                    ...
                    {/* Rating & Review */}
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mt-4 w-full md:w-auto">
                      ...
                      <div className="flex flex-col w-full md:w-72 mt-2 md:mt-0">
                        ...
                        />
                        <button
                          className="bg-pink-600 text-white font-semibold rounded-md mt-3 py-2 px-4 hover:bg-pink-700 transition"
